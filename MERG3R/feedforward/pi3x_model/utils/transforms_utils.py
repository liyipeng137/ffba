...
def save_transforms_json(
    ...
    if intrinsics is None:
        if use_moge_recovery and res is not None:
            print("从 local_points 恢复相机内参...")
            intrinsics = recover_intrinsics_from_output(res)
...
def recover_intrinsics_from_output(res):
    from .geometry_torch import recover_focal_shift
    from .geometry import depth_edge
