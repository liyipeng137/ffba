...
def parse_args():
    parser = argparse.ArgumentParser("Run MERG3R feed-forward SfM pipeline. ")
    ################ MERG3R ################
    ...
    parser.add_argument("--model", type=str, default="pi3x", choices=['pi3x', 'vggt_omega'])
