...
int main(int ac, char** av) 
{
	...
	rng = findArg(cfgLine, "sg_degree");
	int sg_degree = std::stoi(cfgLine.substr(rng.first, rng.second - rng.first));
	...
	// Create the ULR view.
	GaussianView::Ptr	gaussianView(new GaussianView(scene, sceneResWidth, sceneResHeight, plyfile.c_str(), &messageRead, sh_degree, sg_degree, white_background, !myArgs.noInterop, device));
