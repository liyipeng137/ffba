...
def parse_args():
	...
	parser.add_argument("--convention", type=str, default="opencv")
...
if __name__ == "__main__":
	...
	with open(os.path.join(TEXT_FOLDER,"images.txt"), "r") as f:
		...
		for line in f:
			line = line.strip()
			if len(line) == 0: # No points for this camera
				i += 1
				continue
			if line[0] == "#":
				continue
	...
	if args.convention == "opencv":
		...
		raise NotImplementedError("Convention can only be opencv or opengl!")
